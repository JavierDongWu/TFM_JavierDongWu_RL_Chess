...
num_step_to_train = 6_000_000     # The number of steps in the environment needed to complete the training
...
learning_rate=0.001               # The learning rate of the training algorithm
